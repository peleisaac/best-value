...
![Screenshot of Navigation](https://github.com/peleisaac/best-value/blob/main/assets/images/navigation.png)
...
![Screenshot of Slider](https://github.com/peleisaac/best-value/blob/main/assets/images/slider.png)
...
![Screenshot of Products](https://github.com/peleisaac/best-value/blob/main/assets/images/products.png)


### Our Partners
    - This setion shows a list of the partner institutions that we work with.

![Screenshot of Partners](https://github.com/peleisaac/best-value/blob/main/assets/images/partners.png)
...
![Screenshot of Calculator Page](https://github.com/peleisaac/best-value/blob/main/assets/images/calculator.png)
...
## Validator Testing
   ...
   ![Screenshot of the Official W3C Validator](https://github.com/peleisaac/best-value/blob/main/assets/images/w3CValidator.png)
   
    ### Project Validation from the Official Jigsaw Validator
   ![Screenshot of the Official Jigsaw Validator](https://github.com/peleisaac/best-value/blob/main/assets/images/jigsawValidator.png)
...
This project was deployed using Github Pages and the steps taken to accomplish that are as follows:
    ...
    - GitHub generated a link for my site found here: [Project Link](https://peleisaac.github.io/best-value/).
